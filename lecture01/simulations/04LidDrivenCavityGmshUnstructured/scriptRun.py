# Imports the 'os' module to interact with the operating system (e.g., run shell commands)
...
os.system('gmshToFoam cavity.msh')
...
os.system('foamDictionary constant/polyMesh/boundary -entry entry0/movingWall/type -set "wall"')
os.system('foamDictionary constant/polyMesh/boundary -entry entry0/fixedWalls/type -set "wall"')
